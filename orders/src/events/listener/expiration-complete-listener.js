...
const order_created_publisher_1 = require("../publishers/order-created-publisher");
    ...
    onMessage(data, msg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (order.status === common_1.OrderStatus.Complete) {
                console.log('Cancellation aborted since Order has completed already');
                return msg.ack();
            }
            order.set({
            ...
            yield order.save();
            yield new order_created_publisher_1.OrderCancelledPublisher(this.client).publish({
                id: order.id,
